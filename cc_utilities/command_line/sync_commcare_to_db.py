...
def main_with_args(
    ...
    """
    logger.info(f"Retrieving data from {feed_url} and extracting column names")
    ...
    if mapping_did_change:
        logger.info(f"Saving new column state in the directory: {state_path}")
    ...
    logger.info(f"Syncing data from Commcare to db at {database_url_string}")
